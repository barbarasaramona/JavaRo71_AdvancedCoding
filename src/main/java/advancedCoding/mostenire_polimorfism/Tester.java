...
public class Tester extends Employee{
    ...
    public Tester(String name, double baseSalary, Integer yearsOfExperience) {
        super(name, baseSalary, yearsOfExperience);
    }

    public Tester(String name, double baseSalary, Integer yearsOfExperience, int numberOfTests, double testBonus) {
        super(name, baseSalary, yearsOfExperience);
